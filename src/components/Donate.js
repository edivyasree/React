   ...
   const  food_type = [{
    ...
    const handleclick=(e)=>{
      debugger
        ...
        axios.post("http://192.168.3.97:5000/api/Food/",obj,{
            auth: {
                username: "ramesh",
                password: 12345
              }
        ...
        <div>
            ...
            <div className="row">
                <div className='col-lg-6 col-md-6 col-6'>
                    <img src={donate} style={{ height: "709px" }} />
                </div>
                <div className='col-lg-6 col-md-6 col-6'>
                    <Form>
                        <h3 className='textHeading mt-4'>Donate Food</h3>
                        <Form.Group className="mt-4" >
                            <Row>
                                <Col sm="3">
                                    <Form.Label><span ><p className='py-2 pcolor' >Food Name:</p></span></Form.Label></Col>
                                <Col sm="7">
                        ...
                        <Form.Group className="mt-1" >
                            <Row>
                                <Col sm="3">
                                    <Form.Label><span ><p className='py-2 pcolor' >Contact:</p></span></Form.Label></Col>
                                <Col sm="7">
